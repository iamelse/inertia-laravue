        ...
        <div class="relative" ref="userDropdown">
          ...
          >
            <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
              <img src="https://dummyimage.com/300" alt="User" />
            </span>

            <span class="text-theme-sm mr-1 block font-medium"> {{ userName }} </span>
...
// Emits
const emit = defineEmits(['update:sidebarToggle', 'toggle-dark-mode'])
...
// User data
const userName = ref('Musharof')
const userFullName = ref('Musharof Chowdhury')
...
// Methods
const toggleSidebar = () => {
  emit('update:sidebarToggle', !props.sidebarToggle)
}
